...
const allItems: Array<{ id: Page; label: string; icon: string; adminOnly?: boolean }> = [
  ...
  { id: 'resumes', label: '简历中心', icon: '▤' },
  { id: 'applications', label: '投递进度', icon: '◎' },
  { id: 'candidate', label: '个人中心', icon: '○' },
  { id: 'agent', label: '求职 Agent', icon: '✦' },
...
<template>
  <aside class="sidebar">
    <div class="brand"><div class="brand-mark">O</div><div><b>OfferFlow</b><small>投递与简历优化工作台</small></div></div>
    <nav>
