...
from career.services.sources import SourceRefreshService
...
def build_services(
    ...
    *,
    ...
    sources = SourceRefreshService(jobs, source_registry or SourceAdapterRegistry())
